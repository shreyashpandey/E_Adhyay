...
public class QuizActivityC4 extends AppCompatActivity {
    Button button;
    ...
    public void aa(View v) {
        ...
        if (activityList.size() == 0) {
            Intent f = new Intent(QuizActivityC4.this, QuizFinished.class);
  ...
  /*  public void zoom(View view)
   ...
   public void onBackPressed(){
    ...
    public void d()
    {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(QuizActivityC4.this);
