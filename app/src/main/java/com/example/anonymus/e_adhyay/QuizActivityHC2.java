...
public class QuizActivityHC2 extends AppCompatActivity {
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activityhc2_quiz);
    ...
    public void aa(View v) {
        ...
        if (activityList.size() == 0) {
            Intent f = new Intent(QuizActivityHC2.this, QuizFinished.class);
  ...
  /*  public void zoom(View view)
   ...
   public void onBackPressed(){
    ...
    public void d()
    {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(QuizActivityHC2.this);
