...
public class LearnActivity1 extends AppCompatActivity implements
    ...
    int imageSwitcherImages[] =
            {R.drawable.o,R.drawable.a,R.drawable.p,R.drawable.m,R.drawable.st};
    String strings[] = {"Orange","Apple","Peach","Mango","Strawberry"};
  ...
  //  private EditText editText;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity1_learn);
        ...
        simpleTextSwitcher.setFactory(new ViewSwitcher.ViewFactory() {
            ...
            public View makeView() {
                ...
                // create a TextView
                TextView t = new TextView(LearnActivity1.this);
   ...
   public boolean onCreateOptionsMenu(Menu menu) {
    ...
    public void onBackPressed(){
        // moveTaskToBack(true);
        super.onBackPressed();
        startActivity(new Intent(LearnActivity1.this, LearnActivity.class));
        finish();
    }
