...
public class LearnActivity2 extends AppCompatActivity {
    ...
    Button bt_click_me,bt_click_me1,bt_click_me2,bt_click_me3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity2_learn);
       ...
       /* String data = "<html><body><h1>Hello, Javatpoint!</h1><img src="s5.gif"</body></html>";
        ...
        bt_click_me.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(LearnActivity2.this, LearnActivity1.class));
                finish();
            }
        });
        ...
        bt_click_me1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(LearnActivity2.this, LearnActivity3.class));
                finish();
            }
        });
        ...
        bt_click_me2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(LearnActivity2.this, LearnActivity4.class));
                finish();
            }
        });
        bt_click_me3 = findViewById(R.id.bt_click_me3);
        bt_click_me3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(LearnActivity2.this, LearnActivity5.class));
                finish();
            }
        });
        ...
        android.view.animation.Animation a3= AnimationUtils.loadAnimation (getApplicationContext(),R.anim.z3);
        android.view.animation.Animation a4= AnimationUtils.loadAnimation (getApplicationContext(),R.anim.z4);
        bt_click_me.startAnimation(a1);
        bt_click_me1.startAnimation(a2);
        bt_click_me2.startAnimation(a3);
        bt_click_me3.startAnimation(a4);
        //while(true) {
    ...
    public void d()
    {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(LearnActivity2.this);
        ...
        builder1.setPositiveButton(
                ...
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        startActivity(new Intent(LearnActivity2.this, LearnActivity.class));
                        finish();
                    }
                });
