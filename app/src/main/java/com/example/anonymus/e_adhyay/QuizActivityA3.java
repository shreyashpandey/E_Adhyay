...
public class QuizActivityA3 extends AppCompatActivity {
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activitya3_quiz);
    ...
    public void onclickbuttonMethod(View v) {
        ...
        if (selectedId == -1) {
            Toast.makeText(QuizActivityA3.this, "Nothing selected", Toast.LENGTH_SHORT).show();
        } else if (genderradioButton.getId() == R.id.radioMale) {
            Toast.makeText(QuizActivityA3.this, genderradioButton.getText(), Toast.LENGTH_SHORT).show();
            ...
            activityList.add(QuizActivityB1.class);
            activityList.add(QuizActivityC1.class);
            activityList.add(QuizActivityD1.class);
            activityList.add(QuizActivityE1.class);
            ...
            switch (number) {
                case 1:
                    activity = QuizActivityB3.class;
                    // We are adding the number of the activity to the list
                    activityList.remove(QuizActivityB3.class);
                    break;
                case 2:
                    activity = QuizActivityC3.class;
                    activityList.remove(QuizActivityC3.class);
                    break;
                case 3:
                    activity = QuizActivityD3.class;
                    activityList.remove(QuizActivityD3.class);
                    break;
                default:
                    activity = QuizActivityE3.class;
                    activityList.remove(QuizActivityE3.class);
                    break;
               /* default:
    ...
    public void d()
    {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(QuizActivityA3.this);
