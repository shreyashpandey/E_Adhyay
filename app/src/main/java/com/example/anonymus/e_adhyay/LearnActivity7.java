...
public class LearnActivity7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity7_learn);
       ...
       /* String data = "<html><body><h1>Hello, Javatpoint!</h1><img src="s5.gif"</body></html>";
        ...
        bt_click_me.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(LearnActivity7.this, LearnActivity10.class));
                finish();
            }
        });
        ...
        bt_click_me1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(LearnActivity7.this, LearnActivity11.class));
                finish();
            }
        });
    ...
    public void d()
    {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(LearnActivity7.this);
        ...
        builder1.setPositiveButton(
                ...
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        startActivity(new Intent(LearnActivity7.this, LearnActivity.class));
                        finish();
                    }
                });
