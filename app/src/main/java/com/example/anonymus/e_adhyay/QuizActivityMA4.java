...
public class QuizActivityMA4 extends AppCompatActivity {
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activityma4_quiz);
    ...
    public void onclickbuttonMethod(View v) {
        ...
        if (selectedId == -1) {
            Toast.makeText(QuizActivityMA4.this, "Nothing selected", Toast.LENGTH_SHORT).show();
        } else if (genderradioButton.getId() == R.id.radioMale) {
            Toast.makeText(QuizActivityMA4.this, genderradioButton.getText(), Toast.LENGTH_SHORT).show();
            ...
            activityList.add(QuizActivityMB4.class);
            activityList.add(QuizActivityMC4.class);
            activityList.add(QuizActivityMD4.class);
            activityList.add(QuizActivityME4.class);
            ...
            switch (number) {
                case 1:
                    activity = QuizActivityMB4.class;
                    // We are adding the number of the activity to the list
                    activityList.remove(QuizActivityMB4.class);
                    break;
                case 2:
                    activity = QuizActivityMC4.class;
                    activityList.remove(QuizActivityMC4.class);
                    break;
                case 3:
                    activity = QuizActivityMD4.class;
                    activityList.remove(QuizActivityMD4.class);
                    break;
                default:
                    activity = QuizActivityME4.class;
                    activityList.remove(QuizActivityME4.class);
                    break;
               /* default:
    ...
    public void d()
    {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(QuizActivityMA4.this);
