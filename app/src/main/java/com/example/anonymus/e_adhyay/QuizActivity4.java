...
public class QuizActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity4_quiz);
    ...
    public void aa(View v) {
        ...
        if (activityList.size() == 0) {
            Intent f = new Intent(QuizActivity4.this, QuizFinished.class);
  ...
  /*  public void zoom(View view)
   ...
   public void d()
   {
       AlertDialog.Builder builder1 = new AlertDialog.Builder(QuizActivity4.this);
