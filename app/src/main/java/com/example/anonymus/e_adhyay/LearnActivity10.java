...
public class LearnActivity10 extends AppCompatActivity implements
    ...
    int imageSwitcherImages[] =
            {R.drawable.d1,R.drawable.d2,R.drawable.d3,R.drawable.d4,R.drawable.d6,R.drawable.d7,R.drawable.d8,R.drawable.d9,R.drawable.d10,R.drawable.d11,R.drawable.d12,R.drawable.d13,R.drawable.d14,R.drawable.d15,R.drawable.d16,R.drawable.d17,R.drawable.d18,R.drawable.d19,R.drawable.d20};
    String strings[] = {"Aeroplane Flys","Dog barks","Elephant has  trunk","Fish swims in Water","Goat grazes on grass","Igloo is made of ice","Lions Roar","Monkey eats banana","Bird home called as nest","Parrot is of green colour","Rabbit eats carrot","Tommato is of red colour","A mango is of yellow colour","Zebra is herbevorous","Spider has eight legs","Kites flies in sky","Turtule have Shell to hide","Snail is slowest animal","Butterfly has four wings"};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity10_learn);
        ...
        simpleTextSwitcher.setFactory(new ViewSwitcher.ViewFactory() {
            ...
            public View makeView() {
                ...
                // create a TextView
                TextView t = new TextView(LearnActivity10.this);
    ...
    public void onBackPressed(){
        // moveTaskToBack(true);
        super.onBackPressed();
        startActivity(new Intent(LearnActivity10.this, LearnActivity.class));
        finish();
    }
