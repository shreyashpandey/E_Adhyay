...
public class LearnActivity4 extends AppCompatActivity implements
    ...
    int imageSwitcherImages[] =
            {R.drawable.s11,R.drawable.s12,R.drawable.s16,R.drawable.d26,R.drawable.d27};
    String strings[] = {"Sunflower", "Lotus","Rose","Lily","Lavender"};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity4_learn);
        ...
        simpleTextSwitcher.setFactory(new ViewSwitcher.ViewFactory() {
            ...
            public View makeView() {
                ...
                // create a TextView
                TextView t = new TextView(LearnActivity4.this);
    ...
    public void onBackPressed(){
        // moveTaskToBack(true);
        super.onBackPressed();
        startActivity(new Intent(LearnActivity4.this, LearnActivity.class));
        finish();
    }
