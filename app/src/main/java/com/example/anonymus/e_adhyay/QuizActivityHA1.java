...
public class QuizActivityHA1 extends AppCompatActivity {
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activityha1_quiz);
    ...
    public void onclickbuttonMethod(View v) {
        ...
        if (selectedId == -1) {
            Toast.makeText(QuizActivityHA1.this, "Nothing selected", Toast.LENGTH_SHORT).show();
        } else if (genderradioButton.getId() == R.id.radioMale) {
            Toast.makeText(QuizActivityHA1.this, genderradioButton.getText(), Toast.LENGTH_SHORT).show();
            ...
            activityList.add(QuizActivityHB1.class);
            activityList.add(QuizActivityHC1.class);
            activityList.add(QuizActivityHD1.class);
            activityList.add(QuizActivityHE1.class);
            ...
            switch (number) {
                case 1:
                    activity = QuizActivityHB1.class;
                    // We are adding the number of the activity to the list
                    activityList.remove(QuizActivityHB1.class);
                    break;
                case 2:
                    activity = QuizActivityHC1.class;
                    activityList.remove(QuizActivityHC1.class);
                    break;
                case 3:
                    activity = QuizActivityHD1.class;
                    activityList.remove(QuizActivityHD1.class);
                    break;
                default:
                    activity = QuizActivityHE1.class;
                    activityList.remove(QuizActivityHE1.class);
                    break;
               /* default:
    ...
    public void d()
    {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(QuizActivityHA1.this);
