...
public class QuizActivityHA2 extends AppCompatActivity {
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activityha2_quiz);
    ...
    public void onclickbuttonMethod(View v) {
        ...
        if (selectedId == -1) {
            Toast.makeText(QuizActivityHA2.this, "Nothing selected", Toast.LENGTH_SHORT).show();
        } else if (genderradioButton.getId() == R.id.radioMale) {
            Toast.makeText(QuizActivityHA2.this, genderradioButton.getText(), Toast.LENGTH_SHORT).show();
            ...
            activityList.add(QuizActivityHB2.class);
            activityList.add(QuizActivityHC2.class);
            activityList.add(QuizActivityHD2.class);
            activityList.add(QuizActivityHE2.class);
            ...
            switch (number) {
                case 1:
                    activity = QuizActivityHB2.class;
                    // We are adding the number of the activity to the list
                    activityList.remove(QuizActivityHB2.class);
                    break;
                case 2:
                    activity = QuizActivityHC2.class;
                    activityList.remove(QuizActivityHC2.class);
                    break;
                case 3:
                    activity = QuizActivityHD2.class;
                    activityList.remove(QuizActivityHD2.class);
                    break;
                default:
                    activity = QuizActivityHE2.class;
                    activityList.remove(QuizActivityHE2.class);
                    break;
               /* default:
    ...
    public void d()
    {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(QuizActivityHA2.this);
