...
public class QuizActivityH1 extends AppCompatActivity {
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activityh1_quiz);
    ...
    public void onclickbuttonMethod(View v) {
        ...
        if (selectedId == -1) {
            Toast.makeText(QuizActivityH1.this, "Nothing selected", Toast.LENGTH_SHORT).show();
        } else if (genderradioButton.getId() == R.id.radioMale) {
            Toast.makeText(QuizActivityH1.this, genderradioButton.getText(), Toast.LENGTH_SHORT).show();
            ...
            activityList.add(QuizActivityH2.class);
            activityList.add(QuizActivityH3.class);
            activityList.add(QuizActivityH4.class);
            activityList.add(QuizActivityH5.class);
            ...
            switch (number) {
                case 1:
                    activity = QuizActivityH2.class;
                    // We are adding the number of the activity to the list
                    activityList.remove(QuizActivityH2.class);
                    break;
                case 2:
                    activity = QuizActivityH3.class;
                    activityList.remove(QuizActivityH3.class);
                    break;
                case 3:
                    activity = QuizActivityH4.class;
                    activityList.remove(QuizActivityH4.class);
                    break;
                default:
                    activity = QuizActivityH5.class;
                    activityList.remove(QuizActivityH5.class);
                    break;
               /* default:
    ...
    public void d()
    {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(QuizActivityH1.this);
