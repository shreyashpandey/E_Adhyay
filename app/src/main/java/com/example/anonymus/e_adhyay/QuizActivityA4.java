...
public class QuizActivityA4 extends AppCompatActivity {
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activitya4_quiz);
    ...
    public void onclickbuttonMethod(View v) {
        ...
        if (selectedId == -1) {
            Toast.makeText(QuizActivityA4.this, "Nothing selected", Toast.LENGTH_SHORT).show();
        } else if (genderradioButton.getId() == R.id.radioMale) {
            Toast.makeText(QuizActivityA4.this, genderradioButton.getText(), Toast.LENGTH_SHORT).show();
            ...
            activityList.add(QuizActivityB4.class);
            activityList.add(QuizActivityC4.class);
            activityList.add(QuizActivityD4.class);
            activityList.add(QuizActivityE4.class);
            ...
            switch (number) {
                case 1:
                    activity = QuizActivityB4.class;
                    // We are adding the number of the activity to the list
                    activityList.remove(QuizActivityB4.class);
                    break;
                case 2:
                    activity = QuizActivityC4.class;
                    activityList.remove(QuizActivityC4.class);
                    break;
                case 3:
                    activity = QuizActivityD4.class;
                    activityList.remove(QuizActivityD4.class);
                    break;
                default:
                    activity = QuizActivityE4.class;
                    activityList.remove(QuizActivityE4.class);
                    break;
               /* default:
    ...
    public void d()
    {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(QuizActivityA4.this);
