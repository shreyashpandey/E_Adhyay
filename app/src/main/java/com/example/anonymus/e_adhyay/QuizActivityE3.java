...
public class QuizActivityE3 extends AppCompatActivity {
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activitye3_quiz);
    ...
    public void onclickbuttonMethod(View v) {
        ...
        if (selectedId == -1) {
            Toast.makeText(QuizActivityE3.this, "Nothing selected", Toast.LENGTH_SHORT).show();
        } else if (genderradioButton.getId() == R.id.radioMale) {
            Toast.makeText(QuizActivityE3.this, genderradioButton.getText(), Toast.LENGTH_SHORT).show();
            ...
            if (activityList.size() == 0) {
                Intent f = new Intent(QuizActivityE3.this, QuizFinished.class);
    ...
    public void d()
    {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(QuizActivityE3.this);
