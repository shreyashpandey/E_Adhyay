...
public class LearnActivity5 extends AppCompatActivity implements
    ...
    int imageSwitcherImages[] =
            {R.drawable.d8,R.drawable.d24,R.drawable.d7,R.drawable.d25,R.drawable.d3};
    String strings[] = {"Lion", "Tiger","Penguin","Peacock","Elephant"};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity5_learn);
        ...
        simpleTextSwitcher.setFactory(new ViewSwitcher.ViewFactory() {
            ...
            public View makeView() {
                ...
                // create a TextView
                TextView t = new TextView(LearnActivity5.this);
    ...
    public void onBackPressed(){
        // moveTaskToBack(true);
        super.onBackPressed();
        startActivity(new Intent(LearnActivity5.this, LearnActivity.class));
        finish();
    }
