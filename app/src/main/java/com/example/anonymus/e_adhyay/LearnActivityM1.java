...
public class LearnActivityM1 extends AppCompatActivity implements
    ...
    int imageSwitcherImages[] =
            {R.drawable.s6,R.drawable.hadoop};
    String strings[] = {"Text Switcher 1", "Text Switcher 2"};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        simpleTextSwitcher.setFactory(new ViewSwitcher.ViewFactory() {
            ...
            public View makeView() {
                ...
                // create a TextView
                TextView t = new TextView(LearnActivityM1.this);
    ...
    public void onBackPressed(){
        // moveTaskToBack(true);
        super.onBackPressed();
        startActivity(new Intent(LearnActivityM1.this, LearnActivity.class));
        finish();
    }
