...
public class QuizActivityA1 extends AppCompatActivity {
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activitya1_quiz);
    ...
    public void onclickbuttonMethod(View v) {
        ...
        if (selectedId == -1) {
            Toast.makeText(QuizActivityA1.this, "Nothing selected", Toast.LENGTH_SHORT).show();
        } else if (genderradioButton.getId() == R.id.radioMale) {
            Toast.makeText(QuizActivityA1.this, genderradioButton.getText(), Toast.LENGTH_SHORT).show();
            ...
            switch (number) {
                case 1:
                    activity = QuizActivityB1.class;
                    // We are adding the number of the activity to the list
                    activityList.remove(QuizActivityB1.class);
                    break;
                case 2:
                    activity = QuizActivityC1.class;
                    activityList.remove(QuizActivityC1.class);
                    break;
                case 3:
                    activity = QuizActivityD1.class;
                    activityList.remove(QuizActivityD1.class);
                    break;
                default:
                    activity = QuizActivityE1.class;
                    activityList.remove(QuizActivityE1.class);
                    break;
               /* default:
  ...
  public void onBackPressed(){
    ...
    public void d()
    {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(QuizActivityA1.this);
