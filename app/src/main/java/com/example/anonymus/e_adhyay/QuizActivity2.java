...
public class QuizActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity2_quiz);
    ...
    public void aa(View v) {
        ...
        if (activityList.size() == 0) {
            Intent f = new Intent(QuizActivity2.this, QuizFinished.class);
  ...
  /*  public void zoom(View view)
   ...
   public void d()
   {
       AlertDialog.Builder builder1 = new AlertDialog.Builder(QuizActivity2.this);
