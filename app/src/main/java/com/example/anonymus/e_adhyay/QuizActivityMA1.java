...
public class QuizActivityMA1 extends AppCompatActivity {
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activityma1_quiz);
    ...
    public void onclickbuttonMethod(View v) {
        ...
        if (selectedId == -1) {
            Toast.makeText(QuizActivityMA1.this, "Nothing selected", Toast.LENGTH_SHORT).show();
        } else if (genderradioButton.getId() == R.id.radioMale) {
            Toast.makeText(QuizActivityMA1.this, genderradioButton.getText(), Toast.LENGTH_SHORT).show();
            ...
            activityList.add(QuizActivityMB1.class);
            activityList.add(QuizActivityMC1.class);
            activityList.add(QuizActivityMD1.class);
            activityList.add(QuizActivityME1.class);
            ...
            switch (number) {
                case 1:
                    activity = QuizActivityMB1.class;
                    // We are adding the number of the activity to the list
                    activityList.remove(QuizActivityMB1.class);
                    break;
                case 2:
                    activity = QuizActivityMC1.class;
                    activityList.remove(QuizActivityMC1.class);
                    break;
                case 3:
                    activity = QuizActivityMD1.class;
                    activityList.remove(QuizActivityMD1.class);
                    break;
                default:
                    activity = QuizActivityME1.class;
                    activityList.remove(QuizActivityME1.class);
                    break;
               /* default:
    ...
    public void d()
    {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(QuizActivityMA1.this);
