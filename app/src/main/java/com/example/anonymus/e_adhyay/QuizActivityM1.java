...
public class QuizActivityM1 extends AppCompatActivity {
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activitym1_quiz);
    ...
    public void onclickbuttonMethod(View v) {
        ...
        if (selectedId == -1) {
            Toast.makeText(QuizActivityM1.this, "Nothing selected", Toast.LENGTH_SHORT).show();
        } else if (genderradioButton.getId() == R.id.radioMale) {
            Toast.makeText(QuizActivityM1.this, genderradioButton.getText(), Toast.LENGTH_SHORT).show();
            ...
            activityList.add(QuizActivityM2.class);
            activityList.add(QuizActivityM3.class);
            activityList.add(QuizActivityM4.class);
            activityList.add(QuizActivityM5.class);
            ...
            switch (number) {
                case 1:
                    activity = QuizActivityM2.class;
                    // We are adding the number of the activity to the list
                    activityList.remove(QuizActivityM2.class);
                    break;
                case 2:
                    activity = QuizActivityM3.class;
                    activityList.remove(QuizActivityM3.class);
                    break;
                case 3:
                    activity = QuizActivityM4.class;
                    activityList.remove(QuizActivityM4.class);
                    break;
                default:
                    activity = QuizActivityM5.class;
                    activityList.remove(QuizActivityM5.class);
                    break;
               /* default:
    ...
    public void d()
    {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(QuizActivityM1.this);
