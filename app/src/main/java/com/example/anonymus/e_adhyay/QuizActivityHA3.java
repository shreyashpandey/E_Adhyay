...
public class QuizActivityHA3 extends AppCompatActivity {
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activityha3_quiz);
    ...
    public void onclickbuttonMethod(View v) {
        ...
        if (selectedId == -1) {
            Toast.makeText(QuizActivityHA3.this, "Nothing selected", Toast.LENGTH_SHORT).show();
        } else if (genderradioButton.getId() == R.id.radioMale) {
            Toast.makeText(QuizActivityHA3.this, genderradioButton.getText(), Toast.LENGTH_SHORT).show();
            ...
            activityList.add(QuizActivityHB3.class);
            activityList.add(QuizActivityHC3.class);
            activityList.add(QuizActivityHD3.class);
            activityList.add(QuizActivityHE3.class);
            ...
            switch (number) {
                case 1:
                    activity = QuizActivityHB3.class;
                    // We are adding the number of the activity to the list
                    activityList.remove(QuizActivityHB3.class);
                    break;
                case 2:
                    activity = QuizActivityHC3.class;
                    activityList.remove(QuizActivityHC3.class);
                    break;
                case 3:
                    activity = QuizActivityHD3.class;
                    activityList.remove(QuizActivityHD3.class);
                    break;
                default:
                    activity = QuizActivityHE3.class;
                    activityList.remove(QuizActivityHE3.class);
                    break;
               /* default:
    ...
    public void d()
    {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(QuizActivityHA3.this);
