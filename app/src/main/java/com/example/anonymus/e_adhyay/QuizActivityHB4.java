...
public class QuizActivityHB4 extends AppCompatActivity {
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activityhb4_quiz);
    ...
    public void onclickbuttonMethod(View v) {
        ...
        if (selectedId == -1) {
            Toast.makeText(QuizActivityHB4.this, "Nothing selected", Toast.LENGTH_SHORT).show();
        } else if (genderradioButton.getId() == R.id.radioMale) {
            Toast.makeText(QuizActivityHB4.this, genderradioButton.getText(), Toast.LENGTH_SHORT).show();
            ...
            if (activityList.size() == 0) {
                Intent f = new Intent(QuizActivityHB4.this, QuizFinished.class);
    ...
    public void d()
    {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(QuizActivityHB4.this);
