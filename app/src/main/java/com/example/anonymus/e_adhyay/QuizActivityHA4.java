...
public class QuizActivityHA4 extends AppCompatActivity {
    Button button;
    ...
    public void onclickbuttonMethod(View v) {
        ...
        if (selectedId == -1) {
            Toast.makeText(QuizActivityHA4.this, "Nothing selected", Toast.LENGTH_SHORT).show();
        } else if (genderradioButton.getId() == R.id.radioMale) {
            Toast.makeText(QuizActivityHA4.this, genderradioButton.getText(), Toast.LENGTH_SHORT).show();
            ...
            activityList.add(QuizActivityHB4.class);
            activityList.add(QuizActivityHC4.class);
            activityList.add(QuizActivityHD4.class);
            activityList.add(QuizActivityHE4.class);
            ...
            switch (number) {
                case 1:
                    activity = QuizActivityHB4.class;
                    // We are adding the number of the activity to the list
                    activityList.remove(QuizActivityHB4.class);
                    break;
                case 2:
                    activity = QuizActivityHC4.class;
                    activityList.remove(QuizActivityHC4.class);
                    break;
                case 3:
                    activity = QuizActivityHD4.class;
                    activityList.remove(QuizActivityHD4.class);
                    break;
                default:
                    activity = QuizActivityHE4.class;
                    activityList.remove(QuizActivityHE4.class);
                    break;
               /* default:
    ...
    public void d()
    {
        AlertDialog.Builder builder1 = new AlertDialog.Builder(QuizActivityHA4.this);
